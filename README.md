...
## Design Achievements
- **Used a color pallete**: I created a color palette on [color.adobe.com](https://color.adobe.com) to make a fixed gradient background for my page. Here is my palette:<br/>![Theo's color palette](./Color_Pallete.jpg)
